...
const mainDecorator = (StoryFn) => {
  return (
    <div>
      <p>
        Lorem ipsum dolor sit amet consectetur <StoryFn />
        elit. Pariatur illum in excepturi similique esse ducimus autem voluptate vel, reiciendis
        veniam nihil eum laudantium ad, vero perspiciatis non molestias, omnis veritatis. Mollitia,
        nam temporibus dignissimos, deleniti voluptas dolorum eligendi in, necessitatibus asperiores{" "}
        <StoryFn />
        ...
        voluptatibus, aspernatur esse <StoryFn />, sapiente culpa dolor. Magni perspiciatis neque
        minima, quibusdam voluptates deleniti ipsam. Ut exercitationem aperiam omnis quibusdam saepe
        aliquam veritatis sed, consequatur laborum laudantium autem doloribus aliquid odio ratione
        voluptas, eius animi? Iure inventore tenetur tempora recusandae expedita amet, laboriosam
        saepe deleniti?
      </p>
    </div>
  );
...
Default.argTypes = {
  ...
  tooltip: {
    description: "Окно всплывающей подсказки. Может быть как текстом, так и любой HTML структурой",
  },
  preferSide: {
    description:
...
TooltipLink.args = {
  ...
  children: (
    <a className="someClass" href="https://www.youtube.com/feed/subscriptions" target="_blank">
      I`am link
    </a>
  ),
};
