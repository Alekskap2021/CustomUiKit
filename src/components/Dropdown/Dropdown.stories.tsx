    ...
    <div style={{ margin: '1em 0' }}>
      ...
      >
        ...
        <div>
            ...
            laborum at, accusamus nulla ipsa facilis nobis dolorum corporis vero impedit
            voluptatibus et. Voluptatem ipsa libero, velit soluta magnam sequi natus ad ut fugiat
            harum expedita tenetur at, aliquam odit. Eligendi aliquid ex voluptatem, accusamus quos
            magni omnis quas ea numquam ut excepturi nostrum optio alias nisi aut. Quas reiciendis
            ipsa sapiente beatae! Officia debitis labore incidunt, fugiat, ipsa esse molestias optio
            dolores, repudiandae nesciunt minus aperiam vel tenetur. Est nisi suscipit error
            corrupti repudiandae totam, rerum aliquid perspiciatis debitis reiciendis fuga
            architecto cum atque molestiae tenetur harum nam!
        </div>
        {/* <StoryFn /> */}
        ...
        <div>
            ...
            dolores, repudiandae nesciunt minus aperiam vel tenetur. Est nisi suscipit error
            corrupti repudiandae totam, rerum aliquid perspiciatis debitis reiciendis fuga
            architecto cum atque molestiae tenetur harum nam! Lorem ipsum dolor sit amet,
            consectetur adipisicing elit. Quaerat accusantium voluptates laborum at, accusamus nulla
            ipsa facilis nobis dolorum corporis vero impedit voluptatibus et. Voluptatem ipsa
            libero, velit soluta magnam sequi natus ad ut fugiat harum expedita tenetur at, aliquam
            odit. Eligendi aliquid ex voluptatem, accusamus quos magni omnis quas ea numquam ut
            excepturi nostrum optio alias nisi aut. Quas reiciendis ipsa sapiente beatae! Officia
            debitis labore incidunt, fugiat, ipsa esse molestias optio dolores, repudiandae nesciunt
            minus aperiam vel tenetur. Est nisi suscipit error corrupti repudiandae totam, rerum
            aliquid perspiciatis debitis reiciendis fuga architecto cum atque molestiae tenetur
            ...
            rerum aliquid perspiciatis debitis reiciendis fuga architecto cum atque molestiae
            tenetur harum nam! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat
            accusantium voluptates laborum at, accusamus nulla ipsa facilis nobis dolorum corporis
            vero impedit voluptatibus et. Voluptatem ipsa libero, velit soluta magnam sequi natus ad
            ut fugiat harum expedita tenetur at, aliquam odit. Eligendi aliquid ex voluptatem,
            accusamus quos magni omnis quas ea numquam ut excepturi nostrum optio alias nisi aut.
            Quas reiciendis ipsa sapiente beatae! Officia debitis labore incidunt, fugiat, ipsa esse
            molestias optio dolores, repudiandae nesciunt minus aperiam vel tenetur. Est nisi
            ...
            voluptates laborum at, accusamus nulla ipsa facilis nobis dolorum corporis vero impedit
            voluptatibus et. Voluptatem ipsa libero, velit soluta magnam sequi natus ad ut fugiat
            harum expedita tenetur at, aliquam odit.
        </div>
    </div>
);
...
export default {
    ...
    argTypes: {
        ...
        withArrow: {
            description:
                'Определяет, нужно ли показывать стрелку, которая указывает на центр триггера',
            defaultValue: true,
        },
        tooltipClassName: {
        ...
        size: {
            description: 'Размер шрифта и внутренних отступов',
            defaultValue: 'm',
        },
        loading: {
            description: 'Смена контента внутри кнопки на loader',
            defaultValue: false,
        },
        disabled: {
            description: 'Отключает все события и наведение на элементе',
            defaultValue: false,
        },
        clip: {
        ...
        fullSize: {
            description: 'Растянуть элемент на 100% ширины родителя',
            defaultValue: false,
        },
    },
    parameters: {
